...
set EXTERNALBONUSAMOUNT=0.0, EXTERNALBONUS=0, INTERNALBONUSAMOUNT=0.0,
    INTERNALBONUS=0, SOURCINGBUDGET=NULL, TRAVELCOSTS=NULL,
    RELOCATIONCOSTS=NULL, OTHERCOSTS=NULL, ADDITIONALINFORMATION=NULL,
...
where JOBINFORMATIONNO=16256;"""
    ...
    def test_spacesaroundequal(self):
        result = format(self.original_raw, reindent=True)
